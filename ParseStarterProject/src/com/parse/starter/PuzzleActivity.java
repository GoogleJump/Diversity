...
//		if (currentUser != null) {
//			// get puzzleID from current user
//			puzzleID = currentUser.getInt("puzzleID");
//			
//			// get puzzle from puzzleID
//			ParseQuery<Puzzle> query = ParseQuery.getQuery("Puzzle");
//			query.whereEqualTo("ID", puzzleID);
//			query.getFirstInBackground(new GetCallback<Puzzle>() {
//				public void done(Puzzle puzzleObject, ParseException e) {
//					if (e == null) {
...
//=======
		...
		String ingredient = ParseUser.getCurrentUser().getString("currentIngredient");
